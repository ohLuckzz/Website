...
export default {
  siteTitle: "Welcome to the HAVOC!",
  siteTitleBody: (
    <span>
      ...
      , enabling us to leverage the extensive knowledge provided by a network of
      college coaches, professional coaches, and Major League Baseball scouts.
    </span>
  ),
    ...
    body: (
      <span>
        ...
        <a
          rel="noopener noreferrer"
          target="_blank"
          href="https://www.mlb.com/pitch-smart/pitching-guidelines"
        >
